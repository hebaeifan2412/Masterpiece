                            ...
                            <div class="section-card mb-4">
                                ...
                                <div class="section-body p-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-floating">
                                                <input type="text" name="thirdname" class="form-control" id="thirdname"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                ...
                                                <input type="file" name="image" class="ps-2 form-control"
                                                    id="image" accept="image/*">
                                                <small class="text-muted">Profile Image (JPG, PNG, JPEG)</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                ...
                                                <div class="invalid-feedback">
                                                    Password at least 8 char and include at least one uppercase ,lowercase
                                                    letterand digit </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                                <input type="text" name="national_id" class="form-control"
                                                    id="national_id" placeholder="National ID" pattern="\d{10}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <input type="text" name="mother_name" class="form-control"
                                                    id="mother_name" placeholder="Mother's Name" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <input type="text" name="father_phone" class="form-control"
                                                    id="father_phone" placeholder="Father's Phone" maxlength="10"
                                                    required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-floating">
                                                <input type="text" name="mother_phone" class="form-control"
                                                    id="mother_phone" placeholder="Mother's Phone" maxlength="10"
                                                    required>
